    ...
    <>
      ...
      <div>
        <ul className="flex flex-col items-center w-full  px-4 lg:px-20 py-0 lg:py-3">
          <li className=" lg:border-l-[2px] border-slate-100 h-[550%]  absolute z-[-1]  left-4 lg:left-20"></li>
          <li className="lg:border-l-[2px] border-slate-100  left-[50%] h-[550%]  absolute z-[-1]"></li>
